var displacementSlider = function displacementSlider(opts) {
    ...
    var images = opts.images, image = void 0, sliderImages = [];
    ...
    var renderW = void 0, renderH = void 0;
    ...
    var mat = new THREE.ShaderMaterial({
        ...
        }, vertexShader: vertex, fragmentShader: fragment, transparent: true, opacity: 1.0
    });
    ...
    var addEvents = function addEvents() {
        ...
        pagButtons.forEach(function (el, i) {
            el.addEventListener('click', function () {
                ...
                if (!isAnimating) {
                    ...
                    TweenLite.to(mat.uniforms.dispFactor, 1, {
                        value: 1, ease: 'Expo.easeInOut', onComplete: function onComplete() {
                    ...
                    TweenLite.fromTo(slideTitleEl, 0.5, {autoAlpha: 1, filter: 'blur(0px)', y: 0}, {
                        autoAlpha: 0,
                        filter: 'blur(10px)',
                        y: 20,
                        ease: 'Expo.easeIn',
                        onComplete: function onComplete() {
                            ...
                            TweenLite.to(slideTitleEl, 0.5, {autoAlpha: 1, filter: 'blur(0px)', y: 0});
                        }
                    });
                    TweenLite.fromTo(slideStatusEl, 0.5, {autoAlpha: 1, filter: 'blur(0px)', y: 0}, {
                        autoAlpha: 0,
                        filter: 'blur(10px)',
                        y: 20,
                        ease: 'Expo.easeIn',
                        onComplete: function onComplete() {
                            ...
                            TweenLite.to(slideStatusEl, 0.5, {autoAlpha: 1, filter: 'blur(0px)', y: 0, delay: 0.1});
                        }
                    });
                }
            });
        ...
        setInterval(function () {
            index++;
            if (index >= pagButtons.length) index = 0;
            pagButtons[index].click();
        }, 2000);
    };
    addEvents();
